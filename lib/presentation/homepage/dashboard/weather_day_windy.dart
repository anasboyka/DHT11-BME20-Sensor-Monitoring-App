...
class WeatherWindy extends StatefulWidget {
  final Weather weather;
  const WeatherWindy({Key? key, required this.weather}) : super(key: key);

  @override
  State<WeatherWindy> createState() => _WeatherWindyState();
}

class _WeatherWindyState extends State<WeatherWindy> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  height: 200.w,
                  //width: 256.w,
                  child: Lottie.asset('assets/lottie/4806-weather-windy.json'),
                ),
                Text(
                  "Cloudy",
                  style: kwtextStyleRD(
