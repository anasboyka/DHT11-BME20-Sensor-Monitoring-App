...
class WeatherHot extends StatefulWidget {
  final Weather weather;
  const WeatherHot({Key? key, required this.weather}) : super(key: key);

  @override
  State<WeatherHot> createState() => _WeatherHotState();
}

class _WeatherHotState extends State<WeatherHot> {
  @override
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  height: 200.w,
                  child: Lottie.asset('assets/lottie/82378-sunny-weather.json'),
                ),
                Text(
                  "It's Hot",
                  style: kwtextStyleRD(
